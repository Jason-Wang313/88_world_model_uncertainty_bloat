...
Honest strongest claim: `Expose cases where uncertainty mechanisms hide missing mechanics instead of repairing them.` is a plausible branch-structured mechanism for robot world-model reliability, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
