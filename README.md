...
This repository contains a hardened, honest workshop-only robotics paper draft for `world_model_uncertainty_bloat`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/88.pdf`
