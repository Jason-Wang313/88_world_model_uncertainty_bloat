...
\usepackage{url}
\usepackage{booktabs}
\title{World-Model Uncertainty Bloat: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot world-model reliability. The original research bet was: Expose cases where uncertainty mechanisms hide missing mechanics instead of repairing them. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item An Investigation into Uncertainty Quantification of Shallow Foundation Failure Mechanisms in Horizontally Stratified Layered Soil Strata (2026)
\item VLS: Steering Pretrained Robot Policies via Vision-Language Models (2026)
\item Uncertainty-Calibrated Safety Gating for Vision-Language- Action Manipulation Under Domain Shift: Reliability Gains and Intervention-Efficiency Trade-Offs (2026)
\item Zero-Shot Uncertainty-Aware Deployment of Simulation Trained Policies on Real-World Robots (2021)
\item Bayesian Controller Fusion: Leveraging Control Priors in Deep Reinforcement Learning for Robotics (2021)
\end{itemize}
